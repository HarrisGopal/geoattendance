...
import OreCustomList from './EmployeeWise_List';
 
import {PropertyJson,Nanojson,Paramjson, Datamodel, GlobalVariables} from './EmployeeWise_Config'; 
...
export default class EmployeeWise extends Component {
...
this.handleBackButtonClick,
 ...
 componentWillUnmount=()=>{
	...
	Flat_1_onPress= async (item, index)=>{
		Orefuncs.SetLocalStorage("Flat_1_O433946",item);
