...
import OreCustomList from './EmployeeWiseAdmin_List';
 
import {PropertyJson,Nanojson,Paramjson, Datamodel, GlobalVariables} from './EmployeeWiseAdmin_Config'; 
...
export default class EmployeeWiseAdmin extends Component {
...
this.handleBackButtonClick,
 ...
 componentWillUnmount=()=>{
	...
	Flat_1_onPress= async (item, index)=>{
		Orefuncs.SetLocalStorage("Flat_1_O434099",item);
